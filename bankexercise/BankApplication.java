...
public class BankApplication extends JFrame {
	...
	private JLabel accountIDLabel, accountNumberLabel, firstNameLabel, surnameLabel, accountTypeLabel, balanceLabel,
			overdraftLabel;
	private JTextField accountIDTextField, accountNumberTextField, firstNameTextField, surnameTextField,
			accountTypeTextField, balanceTextField, overdraftTextField;
	...
	public void initComponents() {
		...
		ActionListener first = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(table.isEmpty()) {
					JOptionPane.showMessageDialog(null, "There are no records created");
				}
				else {
					saveOpenValues();
					currentItem = 0;
	...
	public static void main(String[] args) {
		...
		bankApplication.setSize(1200, 400);
